...
@knime_util.create_node_description(
    ...
    description="This node evaluates the fitness of the input Petri net with respect to the input event log. The fitness is computed using the token-based replay method."
)
