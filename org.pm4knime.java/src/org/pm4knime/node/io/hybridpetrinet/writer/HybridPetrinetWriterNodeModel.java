...
final class HybridPetrinetWriterNodeModel {
	...
	private static String pathWithExtension(final String path, final HybridPetrinetWriterNodeSettings settings) {
