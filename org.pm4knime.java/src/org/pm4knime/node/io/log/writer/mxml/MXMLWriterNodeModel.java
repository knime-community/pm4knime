...
final class MXMLWriterNodeModel {
	...
	private static void writeToFile(OutputStream outputStream, XLog log, final MXMLWriterNodeSettings settings)
			throws IOException {
	...
	private static String pathWithExtension(final String path, final MXMLWriterNodeSettings settings) {
