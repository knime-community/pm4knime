...
public final class XESWriterNodeSettings extends WriterNodeSettings {
	...
	@Widget(
		title = "Compress output file (gz)", 
		description = "Choose whether to compress the output file or not. This option is disabled by default."
	)
	boolean m_compressWithGzipChecker = false;
	
	public String getExtension() {
		return m_compressWithGzipChecker ? ".xes.gz" : ".xes";
	}
}